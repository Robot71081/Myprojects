...
<div class="heading" >
                              <b  class="int"> Shop at &nbsp;</b  ><b class="book">Bookish. </b>  <br>
...
<div id="carouselExampleIndicators" class="carousel slide">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img   src="product_images/banner1" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img    src="product_images/banner2" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img    src="product_images/banner4" class="d-block w-100" alt="...">
    </div>
  </div>
    ...
    <span class="visually-hidden">Next</span>
         ...
         <div class="heading" >
                              <b>FEATURED BOOKS</b>  <br>
                                Our list on Top Featured Books<br>
